                ...
                <div className='grid sm:grid-cols-3 md:grid-cols-2 gap-12 px-12 sm:px-8'>
                    ...
                    <div className='shadow-md shadow-gray-600 rounded-l-xl rounded-r-xl  duration-200 hover:scale-110'>
                        ...
                        <div className='flex items-center justify-center '>
                            <a href="https://restaurant-react-app-rust.vercel.app/" className='w-1/2 px-6 py-3 m-4 duration-200 hover:scale-105 hover:text-gray-400'>Demo</a>
                            <a href="https://github.com/Vargos98/restaurant-react-app" className='w-1 px-6 py-3 m-4 duration-200 hover:scale-105 hover:text-gray-400'>Code</a>
                    ...
                    <div className='shadow-md shadow-gray-600 rounded-l-xl rounded-r-xl duration-200 hover:scale-110'>
                        ...
                        <div className='flex items-center justify-center'>
                            <a href="https://react-essentials-rosy.vercel.app/" className='w-1/2 px-6 py-3 m-4 duration-200 hover:scale-105 hover:text-gray-400'>Demo</a>
                            <a href="https://github.com/Vargos98/react-essentials" className='w-1 px-6 py-3 m-4 duration-200 hover:scale-105 hover:text-gray-400'>Code</a>
                        </div>
                        <p className='text-md bold inline ml-4 mt-5 mb-5 font-bold text-cyan-400'>Tech Stack : <span className=' text-xs mt-2 text-red-300 ml-1 '> React.js</span></p>
                    ...
                    <div className='shadow-md shadow-gray-600 rounded-l-xl rounded-r-xl  duration-200 hover:scale-110'>
                        ...
                        <div className='flex items-center justify-center'>
                            <a href="https://dribble-fashion-week.vercel.app/" className='w-1/2 px-6 py-3 m-4 duration-200 hover:scale-105 hover:text-gray-400'>Demo</a>
                            <a href="https://github.com/Vargos98/profile-page/tree/main" className='w-1 px-6 py-3 m-4 duration-200 hover:scale-105 hover:text-gray-400'>Code</a>
                        </div>
                    ...
                    <div className='shadow-md shadow-gray-600 rounded-l-xl rounded-r-xl duration-200 hover:scale-110'>
                        ...
                        <div className='flex items-center justify-center'>
                            <a href="https://premier-website-beta.vercel.app/" className='w-1/2 px-6 py-3 m-4 duration-200 hover:scale-105 hover:text-gray-400'>Demo</a>
                            <a href="https://github.com/Vargos98/Premier-website" className='w-1 px-6 py-3 m-4 duration-200 hover:scale-105 hover:text-gray-400'>Code</a>
                        </div>
                        <p className='text-md bold inline ml-4 mt-5 mb-5 font-bold text-cyan-400'>Tech Stack : <span className=' text-xs mt-2 text-red-300 ml-1 '> HTML, CSS, GRID-Layout</span> </p>
                    ...
                    <div className='shadow-md shadow-gray-600 rounded-l-xl rounded-r-xl duration-200 hover:scale-110'>
                        ...
                        <div className='flex items-center justify-center'>
                            <a href="https://trendline-dribble.vercel.app/" className='w-1/2 px-6 py-3 m-4 duration-200 hover:scale-105 hover:text-gray-400'>Demo</a>
                            <a href="https://github.com/Vargos98/Trendline-dribble" className='w-1 px-6 py-3 m-4 duration-200 hover:scale-105 hover:text-gray-400'>Code</a>
                        </div>
                    ...
                    <div className='shadow-md shadow-gray-600 rounded-l-xl rounded-r-xl   duration-200 hover:scale-110'>
                        ...
                        <div className='flex items-center justify-center'>
                            <a href="https://the-chaya-chitra.vercel.app/" className='w-1/2 px-6 py-3 m-4 duration-200 hover:scale-105 hover:text-gray-400'>Demo</a>
                            <a href="https://github.com/Vargos98/The-Chaya-Chitra" className='w-1/2 px-6 py-3 m-4 duration-200 hover:scale-105 hover:text-gray-400'>Code</a>
                        </div>
