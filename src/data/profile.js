export const profile = {
  ...
  phone: '+91 9828206117',
  resumePath: '/UmeshKumar_Resume.pdf',
  headline: 'Hi there,',
  loaderLine: 'Welcome',
  summary:
  ...
  facts: [
    ...
    { label: 'Education', value: 'B.Tech CSE, JKLU (2017–2021)' },
    { label: 'Currently', value: 'Full-Stack Developer, Gudakesa' },
    { label: 'Focus', value: 'MERN, TypeScript, Jira SaaS' },
  ],
};
